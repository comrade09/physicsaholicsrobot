            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        ...
                        InlineKeyboardButton(text="🌀 Batches", callback_data="lectures", style=ButtonStyle.PRIMARY),
                        InlineKeyboardButton(text="🌀 Games", callback_data="games", style=ButtonStyle.PRIMARY),
                    ],
                    [
